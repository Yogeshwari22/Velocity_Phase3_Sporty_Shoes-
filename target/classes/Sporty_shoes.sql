...
reportPrice int(20));
insert into purchase_report values(1,"Strickrer","ynpatil2230@gmail.com","18-04-2000",399);
...
insert into user values(1,"Yogeshwari","ynpatil2230@gmail.com",22,"Female","D Honnur");
select * from user;
